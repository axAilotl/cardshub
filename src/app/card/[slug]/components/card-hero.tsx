...
interface CardHeroProps {
  ...
  onDownload: (format: 'png' | 'json') => void;
}
          ...
          <div className="flex-1">
            ...
            <div className="flex flex-wrap items-center gap-4 mb-4 p-3 rounded-lg bg-deep-space/50">
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`font-bold text-lg ${score >= 0 ? 'text-aurora' : 'text-red-400'}`}>
                  {score >= 0 ? '+' : ''}{score}
                </span>
              ...
              {card.hasAlternateGreetings && (
                <Badge variant="info" size="sm" className="flex items-center gap-1">
                  ...
                  {card.alternateGreetingsCount + 1} Greeting{card.alternateGreetingsCount !== 0 ? 's' : ''}
                </Badge>
              )}
              {card.hasLorebook && (
            ...
            <div className="flex flex-wrap gap-2">
              <Button variant="primary" size="sm" onClick={() => onDownload('png')}>
